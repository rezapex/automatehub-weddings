...
import { Upload, Users, Wand2, Moon, Sun } from "lucide-react";
...
const layoutTemplates = [
  {
    id: "grid3x3",
    name: "3x3 Grid",
    svg: "M0 0h3v3H0zM4 0h3v3H4zM8 0h3v3H8zM0 4h3v3H0zM4 4h3v3H4zM8 4h3v3H8zM0 8h3v3H0zM4 8h3v3H4zM8 8h3v3H8z",
  },
  {
    id: "mixedLayout",
    name: "Mixed Layout",
    svg: "M0 0h3v3H0zM4 0h3v3H4zM8 0h3v6H8zM0 4h3v3H0zM4 4h3v3H4zM0 8h7v3H0z",
  },
  {
    id: "longTables",
    name: "Long Tables",
    svg: "M0 0h11v3H0zM0 4h11v3H0zM0 8h11v3H0z",
  },
];

export function SeatingChartCreator() {
  ...
  const handleGenerateChart = async () => {
    ...
    setTimeout(() => {
      setGeneratedChart(
        "Your AI-generated seating chart is ready! Here's a summary:\n\n" +
          "- Total guests: " +
          guests.split("\n").length +
          "\n" +
          "- Layout: " +
          layoutTemplates.find((l) => l.id === selectedLayout)?.name +
          "\n" +
      ...
      <CardContent className="space-y-6">
        ...
        <div>
          <Button
            ...
            disabled={!selectedLayout || !guests}
          >
